...
SimpleForm.setup do |config|
  ...
  config.wrappers :nowrapper, tag: 'div', class: 'form-group', error_class: 'error has-error' do |b|
     b.use :html5
     b.use :placeholder
     b.use :input
     b.use :error, wrap_with: { tag: 'span', class: 'help-inline help-block' }
     b.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
     # b.wrapper tag: 'div' do |ba|
     #   ba.use :input
     #   ba.use :error, wrap_with: { tag: 'span', class: 'help-inline help-block' }
     #   ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block' }
     # end
   end
  ...
  config.wrappers :div_8, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
